...
# Journal the package is currently addressed to.  The submission order agreed
# with the co-author is Advanced Engineering Informatics, then Knowledge-Based
# Systems, then Cluster Computing; all three take elsarticle sources.
